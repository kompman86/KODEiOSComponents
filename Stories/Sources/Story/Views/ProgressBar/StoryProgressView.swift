...
public class StoryProgressView: UIProgressView {
  ...
  public func simulateProgress(withDuration duration: TimeInterval,
  ...
  public func updatePausedSimulationProgress() {
    if isPaused {
