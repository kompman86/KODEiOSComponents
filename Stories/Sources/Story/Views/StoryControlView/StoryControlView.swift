...
public class StoryControlView: UIView {
  // MARK: - Properties
  
  public var onDidRequestToClose: (() -> Void)?
  public var onDidTapLike: (() -> Void)?
  public var onDidRequestToShowNextStory: (() -> Void)?
  ...
  public func configure(with viewModel: StoryControlViewModelProtocol) {
    closeButton.tintColor = viewModel.controlsTintColor
    likeButton.tintColor = viewModel.controlsTintColor
    closeButton.setImage(viewModel.closeIcon, for: .normal)
...
public extension StoryControlView {
